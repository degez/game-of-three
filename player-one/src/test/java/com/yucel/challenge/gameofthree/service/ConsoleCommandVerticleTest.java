...
import com.yucel.challenge.gameofthree.PlayerOneMainVerticle;
...
public class ConsoleCommandVerticleTest {
  ...
  void deploy_verticle(Vertx vertx, VertxTestContext testContext) {
    vertx.deployVerticle(new PlayerOneMainVerticle(), testContext.succeeding(id -> testContext.completeNow()));
  }
  ...
  void givenNonInitializedPlayer_whenRequestStatus_thenGetNullMoveObject(Vertx vertx, VertxTestContext testContext) throws Throwable{
    vertx.eventBus().request("com.yucel.game.status.player.one", null, messageAsyncResult -> {
      // move object
